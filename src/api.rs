...
pub mod rpc_node_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_consensus_state_json(
            &mut self,
            request: impl tonic::IntoRequest<super::super::consensus::GetConsensusStatusRequest>,
        ) -> std::result::Result<tonic::Response<::prost::alloc::vec::Vec<u8>>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/api.RpcNode/GetConsensusStateJSON");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("api.RpcNode", "GetConsensusStateJSON"));
            self.inner.unary(req, path, codec).await
        }
        /// GetConsensusValidators Gets the consensus node list
        pub async fn get_consensus_validators(
            &mut self,
            request: impl tonic::IntoRequest<super::super::consensus::GetConsensusStatusRequest>,
        ) -> std::result::Result<tonic::Response<super::super::consensus::Validators>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/api.RpcNode/GetConsensusValidators");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("api.RpcNode", "GetConsensusValidators"));
            self.inner.unary(req, path, codec).await
        }
        /// GetConsensusHeight Gets the height of the block that the node is currently agreeing on
        pub async fn get_consensus_height(
            &mut self,
            request: impl tonic::IntoRequest<super::super::consensus::GetConsensusStatusRequest>,
        ) -> std::result::Result<tonic::Response<u64>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/api.RpcNode/GetConsensusHeight");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("api.RpcNode", "GetConsensusHeight"));
            self.inner.unary(req, path, codec).await
        }
    }
}
